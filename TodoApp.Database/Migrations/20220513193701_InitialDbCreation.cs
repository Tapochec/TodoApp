        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ListGroups_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskLists_ListGroups_TaskGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Desc = table.Column<string>(type: "nvarchar(2000)", nullable: true),
                    Completed = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CompletionDt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListGroups_UserId",
                table: "ListGroups",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskLists_TaskGroupId",
                table: "TaskLists",
                column: "TaskGroupId");
